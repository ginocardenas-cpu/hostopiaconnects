  ...
  return (
    ...
    >
      ...
      <div className="flex-1 min-w-0 flex flex-col">
        <div className="font-black mb-2" style={{ fontFamily: "Montserrat, sans-serif", fontSize: "1.05rem" }}>
          {title}
        </div>
    ...
    <div className="w-full max-w-4xl">
      <div className="flex flex-col lg:flex-row gap-8">
        ...
        <div className="lg:w-56 flex-shrink-0 space-y-4">
          <h4 className="text-xs font-bold uppercase tracking-wider text-teal font-montserrat">
            {t("yourSelection")}
          </h4>
          <div className="space-y-3 text-sm">
                              ...
                              >
                                <span className="font-semibold text-charcoal font-montserrat">{t("step1Title")}</span>
                              ...
                              <button
                                ...
                                className="w-full text-left rounded-lg px-2 py-1.5 hover:bg-teal/10 transition-colors border border-transparent hover:border-teal/20"
                              >
                                <span className="font-semibold text-charcoal font-montserrat">{t("step2Title")}</span>
                              ...
                              <button
                                ...
                                className="w-full text-left rounded-lg px-2 py-1.5 hover:bg-teal/10 transition-colors border border-transparent hover:border-teal/20"
                              >
                                <span className="font-semibold text-charcoal font-montserrat">{t("step3Title")}</span>
                              ...
                              <button
                                ...
                                className="w-full text-left rounded-lg px-2 py-1.5 hover:bg-teal/10 transition-colors border border-transparent hover:border-teal/20"
                              >
                                <span className="font-semibold text-charcoal font-montserrat">{t("step4Title")}</span>
                            ...
                            <button
                              ...
                              className="mt-4 w-full inline-flex items-center justify-center gap-1.5 rounded-lg border border-teal/30 bg-transparent px-3 py-2 text-xs font-semibold text-[#555A5E] hover:bg-teal/10 hover:text-teal transition-colors font-montserrat"
                            >
                          ...
                          <div className="flex-1 min-w-0 space-y-6">
                            {wizardStep === 1 && (
                              <>
                                <div className="mb-4 text-center">
                                  <h3 className="text-lg font-black text-charcoal font-montserrat">{t("step1Title")}</h3>
                                ...
                                <div className="flex justify-end">
                                  <motion.button
                                    type="button"
                                    onClick={() => setWizardStep(2)}
                                    className="flex items-center gap-2 rounded-full bg-teal px-6 py-2 font-montserrat text-sm font-bold text-white shadow-md"
                            ...
                            {wizardStep === 2 && (
                              <>
                                <div className="mb-4 text-center">
                                  <h3 className="text-lg font-black text-charcoal font-montserrat">{t("step2Title")}</h3>
                                ...
                                <div className="flex justify-between">
                                  <button type="button" onClick={() => setWizardStep(1)} className="text-sm font-semibold text-teal hover:underline font-montserrat">← {t("back")}</button>
                                  <motion.button
                                    type="button"
                                    onClick={() => setWizardStep(3)}
                                    className="flex items-center gap-2 rounded-full bg-teal px-6 py-2 font-montserrat text-sm font-bold text-white shadow-md"
                            ...
                            {wizardStep === 3 && (
                              <>
                                <div className="mb-4 text-center">
                                  <h3 className="text-lg font-black text-charcoal font-montserrat">{t("step3Title")}</h3>
                                ...
                                <div className="flex justify-between">
                                  <button type="button" onClick={() => setWizardStep(2)} className="text-sm font-semibold text-teal hover:underline font-montserrat">← {t("back")}</button>
                                  <motion.button
                                    type="button"
                                    onClick={() => setWizardStep(4)}
                                    className="flex items-center gap-2 rounded-full bg-teal px-6 py-2 font-montserrat text-sm font-bold text-white shadow-md"
                            ...
                            {wizardStep === 4 && (
                              <>
                                <div className="mb-4 text-center">
                                  <h3 className="text-lg font-black text-charcoal font-montserrat">{t("step4Title")}</h3>
                                ...
                                <div className="flex justify-between">
                                  <button type="button" onClick={() => setWizardStep(3)} className="text-sm font-semibold text-teal hover:underline font-montserrat">← {t("back")}</button>
                                  <motion.button
                                    type="button"
                                    onClick={() => {
                            ...
                            {wizardStep === 5 && (
                              <>
                                <div className="mb-4">
                                  <h3 className="text-lg font-black text-charcoal font-montserrat">{t("viewYourResults")}</h3>
                                  ...
                                  {filteredAssets.length === 0 ? (
                                    ...
                                    filteredAssets.map((asset) => {
                                      ...
                                      return (
                                        ...
                                        >
                                          <div>
                                            <span className="block text-sm font-semibold font-montserrat text-charcoal">{asset.title}</span>
                                ...
                                <button type="button" onClick={() => setWizardStep(4)} className="text-sm font-semibold text-teal hover:underline font-montserrat">← {t("back")}</button>
                              </div>
                                ...
                                <AnimatePresence mode="wait">
                                  {selectedAsset ? (
                                    ...
                                    <motion.p
                                      initial={{ opacity: 0 }}
                                      animate={{ opacity: 1 }}
                                      className="text-sm text-gray-400 py-6 text-center font-raleway"
                                    >
                                      {t("clickAssetToView")}
                                    </motion.p>
                                  )}
