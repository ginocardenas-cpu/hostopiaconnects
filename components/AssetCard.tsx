...
interface AssetCardProps {
  ...
  compact?: boolean;
  /** Portal locale (defaults to `useLocale()` when omitted). */
  locale?: string;
}
...
// Content type to Font Awesome 6 Solid icon mapping (canonical content type)
  ...
  return (
    <Link href={`/assets/${asset.slug}`}>
      ...
      >
        ...
        {/* Description */}
        <p className="text-xs text-gray-500 line-clamp-2 mt-1 font-body">{display.summaryWhat}</p>
